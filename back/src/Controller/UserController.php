...
class UserController extends AbstractController
{
    ...
    public function getUserInfo(Security $security): JsonResponse
    {
        ...
        // If no user is logged in, return an empty response or error
        if (!$user) {
            return new JsonResponse(['error' => 'No user logged in'], 401);
        }

        // Get the user's first name (or whatever you want)
        $firstName = $user->getFirstName();  // Assuming your User entity has a getFirstName() method
